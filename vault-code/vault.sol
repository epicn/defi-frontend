...
contract Vault {
    ...
    function withdraw(uint256 _shares) external {
        ...
        */
        ...
        //     
        //
        if (balanceOf[msg.sender] == 0 && _balanceOfmembershipToken[msg.sender] == 1) {
            uint256 tokenIdToBurn = _membershipTokenOf[msg.sender];
            _ownerOfmembershipToken[tokenIdToBurn] = address(0);
            _balanceOfmembershipToken[msg.sender] = 0;
            _membershipTokenOf[msg.sender] = 0;
        }
    }
